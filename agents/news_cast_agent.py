...
news_cast_agent = Agent(
    ...
    instruction=(
        ...
        "the tool exactly once. Then act as an entertainment beat reporter "
        "covering this production specifically — dates, budget, crew, "
        "filming locations, release timing, distribution deals, casting "
        "announcements. Populate facts with reported facts only (each "
        "attributed to a source URL, in your own words), and rumors with "
